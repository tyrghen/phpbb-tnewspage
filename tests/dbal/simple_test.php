...
class simple_test extends \phpbb_database_test_case
{
	...
	public function test_column()
	{
		...
		$this->assertTrue($db_tools->sql_column_exists(USERS_TABLE, 'user_newspage'), 'Asserting that column "user_newspage" exists');
		$this->assertFalse($db_tools->sql_column_exists(USERS_TABLE, 'user_newspage_void'), 'Asserting that column "user_newspage_void" does not exist');
	}
}
